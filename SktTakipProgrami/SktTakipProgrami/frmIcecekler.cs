...
namespace SktTakipProgrami
{
    public partial class frmIcecekler : Form
    {
        ...
        public void urunEkle()
        {
            ...
            {
                SqlCommand komut = new SqlCommand("insert into Tbl_Icecekler (urunAdi, urunTuru, sktTett) values (@p1, @p2, @p3)", bgl.baglanti());
        ...
        public void UrunGetir()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select secim,urunAdi, urunTuru, sktTett from Tbl_Icecekler", bgl.baglanti());
            da.Fill(dt);
        ...
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter("Select urunAdi, urunTuru, sktTett from Tbl_IcecekIade", bgl.baglanti());
            da.Fill(dt);
        ...
        private void dataGridView1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dataGridView1.Columns["secim"].Index && e.RowIndex >= 0)
            {
                ...
                if (DateTime.TryParse(value3, out sktTett))
                {
                    ...
                    SqlCommand komut = new SqlCommand("insert into Tbl_IcecekIade (urunAdi, urunTuru, sktTett) values (@p1, @p2, @p3)", bgl.baglanti());
                    ...
                    SqlCommand komut2 = new SqlCommand("delete from Tbl_Icecekler where urunAdi = @p1", bgl.baglanti());
                    ...
                    else
                    {
                        ...
                        SqlCommand komut3 = new SqlCommand("delete from Tbl_IcecekIade where sktTett = '1900-01-01'", bgl.baglanti());
